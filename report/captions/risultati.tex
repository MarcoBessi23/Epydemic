...
\subsection{Mean-field approximation}\label{subsec:res-mean-field-approximation}
    ...
    \begin{figure}[H]
        \includegraphics[width=\textwidth]{MF/mf_critical_j}\caption{Mean-field approximation}
...
\subsection{Simple percolation}\label{subsec:res-simple-percolation}
    ...
    \begin{figure}[H]
        \begin{minipage}{0.5\textwidth}
            \includegraphics[width=\linewidth]{SIM/Nodes_10000/critical_t}\label{fig:prob_percolation}
        \end{minipage}
        \begin{minipage}{0.5\textwidth}
            \includegraphics[width=\linewidth]{SIM/critical_t}\label{fig:prob_percolation_2}
        \end{minipage}
...
\subsection{Infezione percezione del rischio}\label{subsec:res-infezione-con-la-percezione-del-rischio}
    ...
    \begin{figure}[H]
        \includegraphics[width=\textwidth]{PERC/Nodes_10000/Iteration_100/graficoJC}\caption{Confronto self percolation and simulation}
        \label{fig:graficoJC}
    \end{figure}
...
\subsection{Multiplex networks}\label{subsec:res-multiplex-networks}
    ...
    \begin{figure}[H]
        \includegraphics[width=\textwidth]{MUL/Nodes_10000/Iteration_100/6Poisson-k-6}\caption{Diagramma di fase al variare di q e $\tau$}
