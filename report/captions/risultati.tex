...
\subsection{Mean-field approximation}\label{subsec:res-mean-field-approximation}
    ...
    \begin{figure}[H]
        \includegraphics[width=\textwidth]{MF/mfjcs-it10000}\caption{Approssimazione di campo medio al variare di $k$}
...
\subsection{Simple percolation}\label{subsec:res-simple-percolation}
    ...
    \begin{figure}[H]
        \includegraphics[width=\linewidth]{SIM/tcs-nodes10000_it10000}
...
\subsection{Infezione percezione del rischio}\label{subsec:res-infezione-con-la-percezione-del-rischio}
    ...
    \begin{figure}[H]
        \includegraphics[width=\textwidth]{PERC/percjcs-k3_nodes10000_it100}
        \caption{Confronto self percolation and simulation con $n=10000$ e 100 iterazioni}
        \label{fig:perc_jcs_k_3}
    \end{figure}

    \begin{figure}[H]
        \includegraphics[width=\textwidth]{PERC/percjcs-k6_nodes10000_it100}
        \caption{Confronto self percolation and simulation con $n=10000$ e 100 iterazioni}
...
\subsection{Multiplex networks}\label{subsec:res-multiplex-networks}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\textwidth]{MUL/Poisson-k6_nodes10000_it100_jm100}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\textwidth]{MUL/Poisson-k6_nodes10000_it100_jminf}
